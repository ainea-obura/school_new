import 'bloc/student_search_qr_code_one_bloc.dart';
import 'models/student_search_qr_code_one_model.dart';
...
class StudentSearchQrCodeOneScreen extends StatelessWidget {
  const StudentSearchQrCodeOneScreen({Key? key}) : super(key: key);

  static Widget builder(BuildContext context) {
    return BlocProvider<StudentSearchQrCodeOneBloc>(
        create: (context) => StudentSearchQrCodeOneBloc(
            StudentSearchQrCodeOneState(
                studentSearchQrCodeOneModelObj: StudentSearchQrCodeOneModel()))
          ..add(StudentSearchQrCodeOneInitialEvent()),
        child: StudentSearchQrCodeOneScreen());
  }

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<StudentSearchQrCodeOneBloc, StudentSearchQrCodeOneState>(
