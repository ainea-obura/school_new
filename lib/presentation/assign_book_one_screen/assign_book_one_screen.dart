import 'bloc/assign_book_one_bloc.dart';
import 'models/assign_book_one_model.dart';
...
class AssignBookOneScreen extends StatelessWidget {
  const AssignBookOneScreen({Key? key}) : super(key: key);

  static Widget builder(BuildContext context) {
    return BlocProvider<AssignBookOneBloc>(
        create: (context) => AssignBookOneBloc(
            AssignBookOneState(assignBookOneModelObj: AssignBookOneModel()))
          ..add(AssignBookOneInitialEvent()),
        child: AssignBookOneScreen());
  }

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<AssignBookOneBloc, AssignBookOneState>(
